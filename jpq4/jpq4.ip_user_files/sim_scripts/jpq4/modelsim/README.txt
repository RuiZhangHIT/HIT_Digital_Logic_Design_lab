...
#
# Generated by export_simulation on Sat Nov 28 23:34:55 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './jpq4.sh' script.
...
./jpq4.sh -noclean_files

For more information on the script, please type './jpq4.sh -help'.
