...
#
# Generated by export_simulation on Sat Nov 07 15:01:52 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './mux_0.sh' script.
...
./mux_0.sh -noclean_files

For more information on the script, please type './mux_0.sh -help'.
